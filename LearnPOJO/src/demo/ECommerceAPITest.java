...
public class ECommerceAPITest {
	...
	public static void main(String[] args) {
		...
		//website for API learning Practice - https://rahulshettyacademy.com/client/
		/*
		 * username - sabariraj443@gmail.com 
		 * Pwd - Learnapi@123
		 */
//SSL
	...
	//loginRequest.setUserEmail("sabariraj443@gmail.com");
	//loginRequest.setUserPassword("Learnapi@123");
	...
	.multiPart("productImage",new File("./disneyland.jpg"));
